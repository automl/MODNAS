...
from search_spaces.hat.fairseq.data.data_utils_fast import batch_by_size_fast
...
def load_indexed_dataset(path, dictionary, dataset_impl=None, combine=False, default='cached'):
    ...
    """
    from search_spaces.hat.fairseq.data.concat_dataset import ConcatDataset
    import  search_spaces.hat.fairseq.data.indexed_dataset as indexed_dataset
