...
from search_spaces.hat.fairseq.models.fairseq_decoder import FairseqDecoder
from search_spaces.hat.fairseq.models.fairseq_encoder import FairseqEncoder
from search_spaces.hat.fairseq.models.fairseq_incremental_decoder import FairseqIncrementalDecoder
from search_spaces.hat.fairseq.models.fairseq_model import (
    BaseFairseqModel,
    FairseqEncoderModel,
...
def register_model_architecture(model_name, arch_name):
    ...
    def register_model_arch_fn(fn):
        ...
        if arch_name in ARCH_MODEL_REGISTRY:
            ...
            #return ARCH_MODEL_REGISTRY[arch_name]
        if not callable(fn):
...
for file in os.listdir(models_dir):
    ...
    if not file.startswith('_') and not file.startswith('.') and (file.endswith('.py') or os.path.isdir(path)):
        ...
        module = importlib.import_module('search_spaces.hat.fairseq.models.' + model_name)
