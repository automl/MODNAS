...
from search_spaces.hat.fairseq.data.indexed_dataset import get_available_dataset_impl
...
def parse_args_and_arch(parser, input_args=None, parse_known=False, suppress_defaults=False):
    ...
    from search_spaces.hat.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY
    ...
    from search_spaces.hat.fairseq.registry import REGISTRIES
    ...
    if hasattr(args, 'task'):
        from search_spaces.hat.fairseq.tasks import TASK_REGISTRY
        TASK_REGISTRY[args.task].add_args(parser)
    if getattr(args, 'use_bmuf', False):
        # hack to support extra args for block distributed data parallelism
        from search_spaces.hat.fairseq.optim.bmuf import FairseqBMUF
...
def add_model_args(parser):
    ...
    from search_spaces.hat.fairseq.models import ARCH_MODEL_REGISTRY
