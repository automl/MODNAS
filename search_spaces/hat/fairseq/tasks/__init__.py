...
from search_spaces.hat.fairseq.tasks.fairseq_task import FairseqTask
...
def register_task(name):
    ...
    def register_task_cls(cls):
        ...
        #print('Registering task {}'.format(name))
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and not file.startswith('_'):
        ...
        importlib.import_module('search_spaces.hat.fairseq.tasks.' + task_name)
