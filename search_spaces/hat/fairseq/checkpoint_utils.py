...
from  search_spaces.hat.fairseq.models import FairseqEncoder, FairseqDecoder


def save_checkpoint(args, trainer, epoch_itr, val_loss, name=''):
    from search_spaces.hat.fairseq import distributed_utils, meters
...
def load_model_ensemble_and_task(filenames, arg_overrides=None, task=None):
    from search_spaces.hat.fairseq import tasks
...
def save_state(
    filename, args, model_state_dict, hpn_state_dict, criterion, optimizer, optimizer_arch, lr_scheduler,
    ...
    state_dict = {
        ...
        'hypernetwork': hpn_state_dict if hpn_state_dict else {},
    ...
    if not args.no_save_optimizer_state:
        ...
        state_dict['last_optimizer_arch_state'] = optimizer_arch.state_dict()
    torch_persistent_save(state_dict, filename)


def _upgrade_state_dict(state):
    """Helper for upgrading old model checkpoints."""
    from search_spaces.hat.fairseq import models, registry, tasks
