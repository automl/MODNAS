...
import os
import torch
from optimizers.help.utils import arch_encoding_ofa as arch_enc
from optimizers.help.utils import data_norm
import numpy as np
...
class EvolutionFinder:
    ...
    def run_evolution_search(self, verbose=False):
        ...
        for _ in range(population_size):
            ...
            if sample == False:
                return "Bad Constraint", "Bad Constraint", "Bad Constraint"
