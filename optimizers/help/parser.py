...
def get_parser():
    with open('optimizers/help/help_ofa.yaml', 'r') as f:
        default_args = yaml.load(f, Loader=yaml.SafeLoader)
    return ArgsObject(default_args)
...
def _get_parser():
    ...
    parser.add_argument('--mode', type=str, default='nas', help='meta-train|meta-test|nas')
    ...
    parser.add_argument('--load_path', type=str, default='datasets/help/nasbench201/checkpoint/help_max_corr.pt', help='model checkpoint path')
    ...
    # Save / Log
    parser.add_argument('--save_path', type=str, default='experiments/help_search', help='')
    ...
    parser.add_argument('--sampled_arch_path', type=str, default='datasets/help/nasbench201/arch_generated_by_metad2a.txt', help="")
    parser.add_argument('--nas_target_device', type=str, default="gold_6226", help="target device of NAS process")
    parser.add_argument('--latency_constraint', type=float, default=11.0, help="latency constraint when performing NAS process")
