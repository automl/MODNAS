...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--experiment_tag",
        type=str,
        default="moautoformerssubimagenet",
    )
    parser.add_argument(
        "--metric",
        type=str,
    ...
    parser.add_argument(
        "--model_type",
        type=str,
        default= "AutoFormer_S"
    )
    parser.add_argument(
        "--config",
        type=str,
        default= "/work/dlclarge1/sukthank-modnas/MODNAS_ICML/rebuttal/MODNAS-patent/search_spaces/AutoFormer/experiments/supernet/supernet-S.yaml"
    )
    parser.add_argument(
        "--predictor_path",
        type=str,
        default="/work/dlclarge1/sukthank-modnas/MODNAS_ICML/rebuttal/MODNAS-patent/predictor_mem_autoformer_S.pth"
    )
    parser.add_argument(
        "--predictor_stats_path",
        type=str,
        default = "/work/dlclarge1/sukthank-modnas/MODNAS_ICML/rebuttal/MODNAS-patent/predictor_stats_S.pkl"
    )
    parser.add_argument(
        "--supernet_path",
        type=str,
        default="/work/dlclarge1/sukthank-modnas/MODNAS_ICML/Cream/AutoFormer/supernet-small.pth"
    )
    ...
    train_file = "autoformer_objective_subimagenet_s.py"
