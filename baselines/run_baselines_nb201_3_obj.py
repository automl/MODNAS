...
if __name__ == "__main__":
    ...
    args.metric_latency = args.metric_latency+"_latency"
    args.metric_energy = args.metric_energy
    config_space = {
    ...
    "metric_energy": args.metric_energy,
    "metric_latency": args.metric_latency
    }
    ...
    #    scheduler = NSGA2(config_space, n_obj=3, **method_kwargs_multi)
    ...
    energy = []
    accuracy = []
    experiment_name = args.experiment_tag+"_"+args.method+"_"+args.metric_latency+"_"+args.metric_energy+"_"+str(args.random_seed)
    print(df.head())
