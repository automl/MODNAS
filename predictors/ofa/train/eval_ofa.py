...
ofa_predictor.load_state_dict(torch.load("predictor_data_utils/ofa/ofa_predictor.pt"))
...
ofa_predictor.eval()
archs = torch.load("datasets/help/ofa_archs.pt")["arch"]
archs_list = []
for i in range(len(archs)):
    archs_list.append(arch_encoding_ofa(archs[i]))
base_path_latencies = "datasets/help/ofa/latency/"
dataloader = Data("meta-test","datasets/help/ofa","ofa", [], [], ["2080ti_1","2080ti_32","2080ti_64","titan_rtx_1","titan_rtx_32","titan_rtx_64","v100_1","v100_32", "v100_64"], num_inner_tasks=8,
                         num_meta_train_sample=4000,
                         num_sample=10,
                         num_query=1000,
                         sampled_arch_path='datasets/help/nasbench201/arch_generated_by_metad2a.txt' )
for device in ["2080ti_1","2080ti_32","2080ti_64","titan_rtx_1","titan_rtx_32","titan_rtx_64","v100_1","v100_32", "v100_64"]:
